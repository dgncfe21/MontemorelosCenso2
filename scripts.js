...
var cars_Ref = firebase.database().ref('/LAMPARAS_E2_MTM');


var dataConductores = firebase.database().ref('/LAMPARAS_E2_MTM');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E2_MTM');
